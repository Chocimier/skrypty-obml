...
html2canvas.Renderer = {
    ...
    Obml: undefined // We are assuming this will be used too
};
...
_html2canvas.Renderer.Obml = function( options ) {
    return { _create:function( zStack, options, doc, queue, _html2canvas ){return budujObml( zStack, options, doc, queue, _html2canvas )} }
}
